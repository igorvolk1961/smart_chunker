"""
Модуль-адаптер для интеграции DocStructSplitter с LangChain.

Предоставляет:
- LangChainAdapter: конвертация JSON-результатов в LangChain Document
- DocStructSplitter(TextSplitter): полноценный TextSplitter для LangChain пайплайнов
...
class LangChainAdapter:
    """Адаптер для преобразования JSON DocStructSplitter в LangChain Document"""
